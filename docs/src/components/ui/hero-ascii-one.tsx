...
export default function AnimationPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black">
      ...
      {/* Top Header */}
      <div className="absolute top-0 left-0 right-0 z-20 border-b border-purple-500/30 backdrop-blur-md bg-purple-900/20">
        <div className="container mx-auto px-4 lg:px-8 py-3 lg:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            <img
              src="./opsidian-logo-transparent.png"
              alt="Opsidian"
              className="w-6 h-6 lg:w-8 lg:h-8 object-contain"
            />
            <div className="font-sans text-white text-xl lg:text-2xl font-bold tracking-tight">
              Opsidian
            </div>
            <div className="h-3 lg:h-4 w-px bg-white/40"></div>
            <span className="text-white/60 text-[8px] lg:text-[10px] font-sans">
              EST. 2025
            </span>
          </div>

          <div className="hidden lg:flex items-center gap-3 text-[10px] font-sans text-white/60"></div>
        </div>
      </div>
        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="flex items-center gap-2 mb-3 opacity-60">
              ...
              <span className="text-white text-[10px] font-sans tracking-wider">
                ∞
              </span>
            ...
            <div className="relative">
              ...
              <h1 className="text-2xl lg:text-5xl font-bold text-white mb-3 lg:mb-4 leading-tight font-sans tracking-tight">
                AGILE VIBE CODE
              </h1>
            </div>
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-sans opacity-80">
                Opsidian is a native macOS desktop application that brings
                powerful AI coding assistance, project management, and
                development workflows to your Mac. Built with Electron for a
                seamless, native experience that runs entirely on your machine.
              </p>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              <a
                href="./Opsidian-1.0.0-arm64.dmg"
                download
                className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent text-white font-sans text-xs lg:text-sm border border-white hover:bg-white hover:text-black transition-all duration-200 group"
              >
              ...
              <a
                href="./Opsidian-1.0.0.dmg"
                download
                className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent border border-white text-white font-sans text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200"
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white"></div>
              <span className="text-white text-[9px] font-sans">
                OPSIDIAN.PROTOCOL
              </span>
            </div>
          </div>
      ...
      {/* Bottom Footer */}
      <div
        className="absolute left-0 right-0 z-20 border-t border-purple-500/30 backdrop-blur-md bg-purple-900/20"
        style={{ bottom: "5vh" }}
      >
        <div className="container mx-auto px-4 lg:px-8 py-2 lg:py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 lg:gap-6 text-[8px] lg:text-[9px] font-sans text-white/50">
          ...
          <div className="flex items-center gap-2 lg:gap-4 text-[8px] lg:text-[9px] font-sans text-white/50">
